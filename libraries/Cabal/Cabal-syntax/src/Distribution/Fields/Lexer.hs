...
{-# LANGUAGE CPP #-}
{-# LANGUAGE MagicHash #-}
{-# LINE 1 "_build/source-dist/ghc-9.10.1-src/ghc-9.10.1/libraries/Cabal/Cabal-syntax/src/Distribution/Fields/Lexer.x" #-}
-----------------------------------------------------------------------------
-- |
...
#endif
{-# LINE 153 "_build/source-dist/ghc-9.10.1-src/ghc-9.10.1/libraries/Cabal/Cabal-syntax/src/Distribution/Fields/Lexer.x" #-}
